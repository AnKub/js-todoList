export class Todo {
  ...
  static #render = () => {
    ...
    if (this.#list.length === 0) {
      this.#block.innerText = `Plan what to spend your time on, because that’s all you have of value.`
    } else {
  ...
  static #createTaskElem = (data) => {
    ...
    btnCancel.onclick = this.#handelCancel(data)
